...
define root view entity ZC_013_TRAVEL
  as projection on ZI_013_TRAVEL
{
      @UI.facet: [ { id: 'Travel',
      purpose: #STANDARD,
  ...
  key mykey              as TravelUUID,
      @UI: {
      lineItem: [ { position: 10, importance: #HIGH }, { type: #FOR_ACTION, dataAction: 'acceptTravel', label: 'Accept Travel' } ],

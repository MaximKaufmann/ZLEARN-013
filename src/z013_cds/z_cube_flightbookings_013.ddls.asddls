@AbapCatalog.sqlViewName: 'Z013CUBEFLIGHTBO'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'CUBE_FLIGHTBOOKINGS'
define view Z_CUBE_FLIGHTBOOKINGS_013 as select from sbook
  ...
  association [0..1] to Z_DIMEN_Connection   as _Connection   on  $projection.Airline          = _Connection.Airline
                                                                  and $projection.FlightConnection = _Connection.FlightConnection
  association [0..1] to Z_DIMEN_CUSTOMER     as _Customer     on  $projection.Customer = _Customer.Customer
  association [0..1] to Z_DIMEN_TRAVELAGENCY as _TravelAgency on  $projection.TravelAgency = _TravelAgency.TravelAgency
{
  /** DIMENSIONS **/
